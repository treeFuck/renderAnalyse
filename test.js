...
const testurl = [
  'http://175.178.108.248:886/test/fps.html', // 测试 fps，后面拼接 ?num=xxx 表示渲染 xxx 个动画
  'http://175.178.108.248:886/test/memory.html', // 测试 memory，后面拼接 ?num=xxx 表示创建 xxx 个大对象
  'http://175.178.108.248:886/test/time.html', // 测试 time，后面拼接 ?num=xxx 表示页面被 js 阻塞 xxx 毫秒
  'http://175.178.108.248:886/homepage.html',
]
